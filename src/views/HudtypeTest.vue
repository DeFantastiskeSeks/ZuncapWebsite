      ...
      <div class="form-hudtype">
        <div class="form-group form-group-text">
          ...
          <select name="nuance" v-model="nuance" class="form-select select-dark" id="nuance">
            <option :value="0" style="background-color: rgb(239, 218, 198);">A</option>
            <option :value="0" style="background-color: rgb(237, 207, 181);">B</option>
            <option :value="1" style="background-color: rgb(232, 200, 155);">C</option>
            <option :value="1" style="background-color: rgb(221, 181, 139);">D</option>
            <option :value="2" style="background-color: rgb(204, 155, 104);">E</option>
            <option :value="2" style="background-color: rgb(185, 147, 95);">F</option>
            <option :value="3" style="background-color: rgb(148, 113, 84);">G</option>
          </select>
        </div>
        <div class="form-group form-group-text">
          <label for="skoldet">
          ...
          <select name="skoldet" v-model="skoldet" class="form-select select-dark" id="skoldet">
            <option :value="0">Bliver altid skoldet</option>
            <option :value="1">Bliver sommetider skoldet</option>
            <option :value="2">Bliver sjældent skoldet</option>
            <option :value="3">Bliver aldrig skoldet</option>
          </select>
        </div>
        <div class="form-group form-group-text">
          <label for="brun">
          ...
          <select name="brun" v-model="brun" class="form-select select-dark" id="brun">
            <option :value="0">Bliver aldrig brun</option>
            <option :value="1">Bliver lidt brun</option>
            <option :value="2">Bliver noget brun</option>
            <option :value="3">Bliver kraftig brun</option>
          </select>
        </div>
        <div class="form-group form-group-text">
          ...
          <select name="øjenfarve" v-model="øjenfarve" class="form-select select-dark" id="øjenfarve">
            <option :value="0" style="background-color: rgb(77, 77, 199)">Blå</option>
            <option :value="1" style="background-color: rgb(110, 110, 110)">Grå</option>
            <option :value="1" style="background-color: rgb(14, 122, 14)">Grøn</option>
            <option :value="2" style="background-color: rgb(103, 52, 12)">Brun</option>
          </select>
        </div>
        <div class="form-group form-group-text">
          <label for="hårfarve">
          ...
          <select name="hårfarve" v-model="hårfarve" class="form-select select-dark" id="hårfarve">
            <option :value="0" style="background-color: rgb(243, 90, 8)">Rødt</option>
            <option :value="0" style="background-color: rgb(252, 237, 116)">Blond</option>
            <option :value="1" style="background-color: rgb(185, 93, 27)">Lysebrunt</option>
            <option :value="2" style="background-color: rgb(98, 51, 21)">Mørkebrunt</option>
            <option :value="2" style="background-color: rgb(34, 13, 2)">Sort</option>
          </select>
        </div>
        <div class="form-group form-group-text">
          <label for="fregner">Har du fregner?</label>
          <select name="fregner" v-model="fregner" class="form-select select-dark" id="fregner">
            <option :value="0">Ja, mange</option>
            <option :value="1">Ja, få</option>
            <option :value="2">Nej</option>
          </select>
        </div>
        <div>
          <button type="submit" class="btn btn-primary" name="submitbtn">Gem</button>
        </div>
      </div>
    </form>
